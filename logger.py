...
handler = TimedRotatingLog(filename="log/Monitor",maxBytes=5242880,backupCount=5,encoding="utf8",when="S",interval= 86400)
...
fileHandler = logging.FileHandler("{0}/{1}.log".format("log", "log2"))
